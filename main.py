...
class CLI:
    ...
    # creates agent -> waits and returns the response 
    async def run_single(self, message: str) -> str | None:
        async with Agent(self.config) as agent:
            self.agent = agent
            return await self._process_message(message)
    
    #prints greetings -> creates agebt with confirmation callback-> creates infinite loop for user char -> handels error and prints goodbye
    ...
    # returns the types of tools agent is using
